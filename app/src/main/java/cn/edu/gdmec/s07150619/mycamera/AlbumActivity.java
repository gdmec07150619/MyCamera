package cn.edu.gdmec.s07150619.mycamera;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mBgList==null){
            ...
            for (int i=0;i<mBgList.length;i++){
                flipper.addView(addImage(mBgList[i]),i,new ViewGroup.LayoutParams
        ...
        sel=new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent event) {
                ...
                if (x>10&&System.currentTimeMillis()>starTime+100){
                    starTime=System.currentTimeMillis();
                    flipper.setInAnimation(AnimationUtils.loadAnimation
                            (AlbumActivity.this,R.anim.push_right_in));
                    flipper.setInAnimation(AnimationUtils.loadAnimation
                            (AlbumActivity.this,R.anim.push_right_out));
                    flipper.showPrevious();
                }else if (x<-10&&System.currentTimeMillis()>starTime+1000){
                    starTime=System.currentTimeMillis();
                    flipper.setInAnimation(AnimationUtils.loadAnimation
                            (AlbumActivity.this,R.anim.push_left_in));
                    flipper.setInAnimation(AnimationUtils.loadAnimation
                            (AlbumActivity.this,R.anim.push_left_out));
                    flipper.showNext();
                }
            }
